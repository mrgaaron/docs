...
When using the HTTP interface directly, supply the documented method's argument
as a JSON body in the HTTP request.

.. todo:: page documenting specifics for HTTP
